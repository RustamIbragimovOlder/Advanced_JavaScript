...
class Book {
    ...
    getMetadata(metadataType) {
        return this[metadataType] ?? []; // если metadataType есть значения - они возвращаются, если их нет - возврат пустого массива
    }
...
book.addMetadata(reviewSymbol, "Семинар №1.");
...
book.addMetadata(ratingSymbol, 4);
book.addMetadata(ratingSymbol, 1);
...
book.addMetadata(tagsSymbol, "непонятно");
