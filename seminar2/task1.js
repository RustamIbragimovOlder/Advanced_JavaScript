...
function checkAmount(amount) {
    if (amount < 0) {
        throw new Error("Сумма должны быть больше 0");
    }
...
console.log(bankAccount.balance);
// bankAccount.withdraw(2000.50);
// console.log(bankAccount.balance); // Uncaught Error: Недостаточно средств
// bankAccount.withdraw(-200);
// console.log(bankAccount.balance); // Uncaught Error: Сумма должны быть больше 0
// bankAccount.deposit(1000.2255);
// console.log(bankAccount.balance); // Uncaught Error: Введите число с 2 знаками после запятой
// bankAccount.withdraw('hfhfh');
// console.log(bankAccount.balance); // Uncaught Error: Некорректная сумма